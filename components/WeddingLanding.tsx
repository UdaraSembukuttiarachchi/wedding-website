    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-stone-50">
      ...
      <nav className="absolute top-0 w-full z-20 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 text-white font-light">
            ...
            <a href="#details" className="hover:text-amber-200 transition-colors">Wedding Details</a>
          </div>
        </div>
      </nav>
      ...
      <div className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="absolute top-20 left-8 opacity-30">
          <svg width="60" height="80" viewBox="0 0 60 80" className="text-sage-400">
            <path d="M30 10 Q20 0, 10 10 Q10 20, 20 25 Q30 30, 40 25 Q50 20, 50 10 Q40 0, 30 10" fill="currentColor" opacity="0.6"/>
            <path d="M15 35 Q10 30, 5 35 Q5 40, 10 42 Q15 45, 20 42 Q25 40, 25 35 Q20 30, 15 35" fill="currentColor" opacity="0.4"/>
            <path d="M40 50 Q35 45, 30 50 Q30 55, 35 57 Q40 60, 45 57 Q50 55, 50 50 Q45 45, 40 50" fill="currentColor" opacity="0.5"/>
          </svg>
        </div>
        
        <div className="absolute bottom-20 right-8 opacity-30 transform rotate-180">
          <svg width="60" height="80" viewBox="0 0 60 80" className="text-amber-400">
            <path d="M30 10 Q20 0, 10 10 Q10 20, 20 25 Q30 30, 40 25 Q50 20, 50 10 Q40 0, 30 10" fill="currentColor" opacity="0.6"/>
            <path d="M15 35 Q10 30, 5 35 Q5 40, 10 42 Q15 45, 20 42 Q25 40, 25 35 Q20 30, 15 35" fill="currentColor" opacity="0.4"/>
            <path d="M40 50 Q35 45, 30 50 Q30 55, 35 57 Q40 60, 45 57 Q50 55, 50 50 Q45 45, 40 50" fill="currentColor" opacity="0.5"/>
          </svg>
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mb-6 animate-fade-in">
              ...
              <p className="text-2xl md:text-3xl lg:text-4xl font-light text-amber-200 italic mb-4 drop-shadow-lg">and</p>
            ...
            <div className="mb-8 animate-slide-up">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center space-y-3 md:space-y-0 md:space-x-8 text-white mb-8">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-base md:text-lg font-light drop-shadow-lg">7:00 PM onwards</span>
                </div>
                <div className="hidden md:block w-px h-6 bg-white/30"></div>
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4 md:w-5 md:h-5 text-amber-400" />
                  <span className="text-base md:text-lg font-light drop-shadow-lg">Eagles Lagoon View, Katunayake</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 animate-slide-up">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 max-w-sm md:max-w-lg mx-auto">
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-3 md:p-4">
                  <div className="text-xl md:text-2xl lg:text-3xl font-light text-white">{timeLeft.days}</div>
                  <div className="text-xs md:text-sm text-amber-200 uppercase tracking-wide">Days</div>
                </div>
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-3 md:p-4">
                  <div className="text-xl md:text-2xl lg:text-3xl font-light text-white">{timeLeft.hours}</div>
                  <div className="text-xs md:text-sm text-amber-200 uppercase tracking-wide">Hours</div>
                </div>
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-3 md:p-4">
                  <div className="text-xl md:text-2xl lg:text-3xl font-light text-white">{timeLeft.minutes}</div>
                  <div className="text-xs md:text-sm text-amber-200 uppercase tracking-wide">Minutes</div>
                </div>
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-3 md:p-4">
                  <div className="text-xl md:text-2xl lg:text-3xl font-light text-white">{timeLeft.seconds}</div>
                  <div className="text-xs md:text-sm text-amber-200 uppercase tracking-wide">Seconds</div>
                </div>
              </div>
            </div>
          ...
          <div className="py-12 md:py-16 px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-base md:text-lg leading-relaxed text-gray-600 font-light italic">
                Welcome to our wedding website! We've created this site as a convenient and interactive way 
                to share all of the important details with you leading up to our wedding. We can't wait to 
                celebrate this exciting new chapter of our lives together with you.
              </p>
            </div>
          </div>
        </div>
